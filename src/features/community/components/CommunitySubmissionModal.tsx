...
export function CommunitySubmissionModal({ isOpen, onClose }: CommunitySubmissionModalProps) {
    ...
    return createPortal(
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
            ...
            {/* Modal Content */}
            <div className="relative w-full max-w-lg bg-[var(--bg-card)] rounded-3xl border-2 border-[var(--border-accent)] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
                {/* Header */}
